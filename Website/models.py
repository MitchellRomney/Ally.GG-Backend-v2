...
class Participant(models.Model):
    ...
    neutral_minions_killed_team_jungle = models.BigIntegerField(blank=False)
    vision_score = models.BigIntegerField(blank=False)
    magic_damage_dealt_to_champions = models.BigIntegerField(blank=False)
    largest_multi_kill = models.BigIntegerField(blank=False)
    total_time_crowd_control_dealt = models.BigIntegerField(blank=False)
    longest_time_spent_living = models.BigIntegerField(blank=False)
    perk1_var1 = models.BigIntegerField(blank=False)
    perk1_var3 = models.BigIntegerField(blank=False)
    perk1_var2 = models.BigIntegerField(blank=False)
    triple_kills = models.BigIntegerField(blank=False)
    ...
    player_score9 = models.BigIntegerField(blank=False)
    player_score8 = models.BigIntegerField(blank=False)
    kills = models.BigIntegerField(blank=False)
    player_score1 = models.BigIntegerField(blank=False)
    player_score0 = models.BigIntegerField(blank=False)
    player_score3 = models.BigIntegerField(blank=False)
    player_score2 = models.BigIntegerField(blank=False)
    player_score5 = models.BigIntegerField(blank=False)
    player_score4 = models.BigIntegerField(blank=False)
    player_score7 = models.BigIntegerField(blank=False)
    player_score6 = models.BigIntegerField(blank=False)
    perk5_var1 = models.BigIntegerField(blank=False)
    perk5_var3 = models.BigIntegerField(blank=False)
    perk5_var2 = models.BigIntegerField(blank=False)
    total_score_rank = models.BigIntegerField(blank=False)
    neutral_minions_killed = models.BigIntegerField(blank=False)
    stat_perk1 = models.BigIntegerField(blank=False)
    stat_perk0 = models.BigIntegerField(blank=False)
    damage_dealt_to_turrets = models.BigIntegerField(blank=False)
    physical_damage_dealt_to_champions = models.BigIntegerField(blank=False)
    damage_dealt_to_objectives = models.BigIntegerField(blank=False)
    perk2_var2 = models.BigIntegerField(blank=False)
    perk2_var3 = models.BigIntegerField(blank=False)
    total_units_healed = models.BigIntegerField(blank=False)
    perk2_var1 = models.BigIntegerField(blank=False)
    perk4_var1 = models.BigIntegerField(blank=False)
    total_damage_taken = models.BigIntegerField(blank=False)
    perk4_var3 = models.BigIntegerField(blank=False)
    wards_killed = models.BigIntegerField(blank=False)
    largest_critical_strike = models.BigIntegerField(blank=False)
    largest_killing_spree = models.BigIntegerField(blank=False)
    quadra_kills = models.BigIntegerField(blank=False)
    magic_damage_dealt = models.BigIntegerField(blank=False)
    ...
    perk3_var3 = models.BigIntegerField(blank=False)
    perk3_var2 = models.BigIntegerField(blank=False)
    perk3_var1 = models.BigIntegerField(blank=False)
    damage_self_mitigated = models.BigIntegerField(blank=False)
    magical_damage_taken = models.BigIntegerField(blank=False)
    perk0_var2 = models.BigIntegerField(blank=False)
    first_inhibitor_kill = models.BooleanField(default=False)
    true_damage_taken = models.BigIntegerField(blank=False)
    assists = models.BigIntegerField(blank=False)
    perk4_var2 = models.BigIntegerField(blank=False)
    gold_spent = models.BigIntegerField(blank=False)
    true_damage_dealt = models.BigIntegerField(blank=False)
    physical_damage_dealt = models.BigIntegerField(blank=False)
    sight_wards_bought_in_game = models.BigIntegerField(blank=False)
    total_damage_dealt_to_champions = models.BigIntegerField(blank=False)
    physical_damage_taken = models.BigIntegerField(blank=False)
    total_player_score = models.BigIntegerField(blank=False)
    win = models.BooleanField(default=False)
    objective_player_score = models.BigIntegerField(blank=False)
    total_damage_dealt = models.BigIntegerField(blank=False)
    neutral_minions_killed_enemy_jungle = models.BigIntegerField(blank=False)
    deaths = models.BigIntegerField(blank=False)
    wards_placed = models.BigIntegerField(blank=False)
    perk_primary_style = models.BigIntegerField(blank=False)
    perk_sub_style = models.BigIntegerField(blank=False)
    turret_kills = models.BigIntegerField(blank=False)
    first_blood_kill = models.BooleanField(default=False)
    true_damage_dealt_to_champions = models.BigIntegerField(blank=False)
    gold_earned = models.BigIntegerField(blank=False)
    killing_sprees = models.BigIntegerField(blank=False)
    unreal_kills = models.BigIntegerField(blank=False)
    first_tower_assist = models.BooleanField(default=False)
    first_tower_kill = models.BooleanField(default=False)
    champ_level = models.BigIntegerField(blank=False)
    double_kills = models.BigIntegerField(blank=False)
    inhibitor_kills = models.BigIntegerField(blank=False)
    first_inhibitor_assist = models.BooleanField(default=False)
    perk0_var1 = models.BigIntegerField(blank=False)
    combat_player_score = models.BigIntegerField(blank=False)
    perk0_var3 = models.BigIntegerField(blank=False)
    vision_wards_bought_in_game = models.BigIntegerField(blank=False)
    penta_kills = models.BigIntegerField(blank=False)
    total_heal = models.BigIntegerField(blank=False)
    total_minions_killed = models.BigIntegerField(blank=False)
    time_ccing_others = models.BigIntegerField(blank=False)
    stat_perk2 = models.BigIntegerField(blank=False)
